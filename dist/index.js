(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["graph-entity"] = factory();
	else
		root["graph-entity"] = factory();
})(this, function() {
...
exports.atomToVariableString = exports.detectDataType = exports.attachGetterSetter = exports.ATOM_TYPE = exports.getOperationKey = exports.getHiddenFieldName = exports.getNewSchemaKey = exports.SCHEMA_NAME = exports.PREFIX = undefined;
...
var SCHEMA_NAME = exports.SCHEMA_NAME = PREFIX + 'schema_name';
...
var ATOM_TYPE = exports.ATOM_TYPE = ['Date', 'String', 'Number', 'Boolean', 'ID', 'Enum'];

var attachGetterSetter = exports.attachGetterSetter = function attachGetterSetter(fieldName, descriptor, displayName, dataType, schemaTree) {
...
var detectDataType = exports.detectDataType = function detectDataType(value) {
...
var atomToVariableString = exports.atomToVariableString = function atomToVariableString(value, dataType) {
  if (value === null || value === undefined) {
    return 'null';
  }
  ...
  if (value instanceof Array) {
    return value.map(function (v) {
      return atomToVariableString(v);
    }).join(',');
  }

  var type = dataType || detectDataType(value);
...
var Schema = function () {
  ...
  function Schema(schemaTree, name, entityClass, paths) {
  ...
  (0, _createClass3.default)(Schema, [{
      ...
      var toString = function toString(fields, innerPaths) {
        ...
        Object.keys(fields).forEach(function (key) {
          ...
          if (_utils.ATOM_TYPE.indexOf(type) >= 0) {
            ...
            result.push('' + spaces + alias + ' {');
            result.push.apply(result, (0, _toConsumableArray3.default)(_this2._schemaTree[type].composeToString(innerPaths.concat(alias), excludes)));
            result.push(spaces + '}');
          }
        });
      };
    ...
    value: function composeResult(data) {
      ...
      var allFields = (0, _extends3.default)({}, this.fields);
      ...
      Object.keys(allFields).forEach(function (key) {
        ...
        if (data[alias] === null) {
          ...
          instance[key] = data[alias] instanceof Array ? data[alias].map(function (d) {
            return _this3._schemaTree[type].composeResult(d);
          }) : _this3._schemaTree[type].composeResult(data[alias]);
        }
      });
    ...
    value: function composeVariables(variables) {
      var _this4 = this;
      ...
      if (variables instanceof Array) {
        return '[' + variables.map(function (item) {
          return _this4.composeVariables(item);
        }).join(',\n') + ']';
      }
      ...
      var allFields = (0, _extends3.default)({}, this.fields);
      Object.keys(this.ons).forEach(function (on) {
        Object.assign(allFields, _this4.ons[on]);
      });

      // if variables is object
      var result = Object.keys(allFields).map(function (key) {
        var _allFields$key2 = allFields[key],
            type = _allFields$key2.type,
            alias = _allFields$key2.alias;

        var value = variables[alias] || variables[key];

        if (value === undefined || value === null) {
          return null;
        }
        if (_utils.ATOM_TYPE.includes(type)) {
          return alias + ': ' + (0, _utils.atomToVariableString)(value, type);
        }

        var schema = _this4._schemaTree[type];
    ...
    value: function generateNestedFields(schemaTree, fields, paths) {
      var AnonymousClass = function AnonymousClass() {};
      var schema = new Schema(schemaTree, null, AnonymousClass, paths);

      AnonymousClass[_utils.SCHEMA_NAME] = schema.schemaKey;

      Object.keys(fields).forEach(function (key) {
        Object.defineProperty(AnonymousClass.prototype, key, (0, _utils.attachGetterSetter)(key, {}, schema.displayName, fields[key], schemaTree));
...
var _createField = __webpack_require__(50);

var _createField2 = _interopRequireDefault(_createField);

var _createFieldOn = __webpack_require__(51);

var _createFieldOn2 = _interopRequireDefault(_createFieldOn);

var _createOperation = __webpack_require__(52);

var _createOperation2 = _interopRequireDefault(_createOperation);

var _createExclude = __webpack_require__(49);

var _createExclude2 = _interopRequireDefault(_createExclude);
...
var _default = function _default(engine) {
  ...
  this.field = (0, _createField2.default)(this._schemaTree);
  this.fieldOn = (0, _createFieldOn2.default)(this._schemaTree);
  this.exclude = (0, _createExclude2.default)(this._schemaTree);
  this.query = (0, _createOperation2.default)(this._schemaTree, engine, false);
  this.mutate = (0, _createOperation2.default)(this._schemaTree, engine, true);
}
/*
...
var outputOne = function outputOne(debug) {
...
window.$GE_LIST = function () {
  $GE_DEBUG.forEach(function (d) {
    return outputOne(d);
  });
};
...
var _default = function () {
  ...
  (0, _createClass3.default)(_default, [{
    key: 'cleanAndFetch',
    value: function cleanAndFetch(metaKey, variables, middleware, afterware) {
      var _this = this;

      var _schemaTree$metaKey = this._schemaTree[metaKey],
          input = _schemaTree$metaKey.input,
          name = _schemaTree$metaKey.name,
          output = _schemaTree$metaKey.output,
          isMutation = _schemaTree$metaKey.isMutation,
          _schemaTree$metaKey$e = _schemaTree$metaKey.excludes,
          excludes = _schemaTree$metaKey$e === undefined ? [] : _schemaTree$metaKey$e;


      var outputFields = this._schemaTree[output].composeToString(['', ''], excludes);
      var intputFields = variables;
      ...
      var body = (isMutation ? 'mutation' : 'query') + ' {\n      ' + name + '(' + intputFields + '){\n        ' + outputFields.join('\n') + '\n      }\n    }';
      ...
      return fetch(this._uri, {
        ...
        var result = _this._schemaTree[output].composeResult(outputData);
        if (afterware) {
    ...
    key: 'stringifyVariables',
    value: function stringifyVariables(variables) {
      var _this2 = this;
      ...
      if (variables instanceof Array) {
        var _result = variables.map(function (v) {
          return _this2.stringifyVariables(v);
        });
        return '[' + _result.join(',\n') + ']';
      }

      if ((typeof variables === 'undefined' ? 'undefined' : (0, _typeof3.default)(variables)) !== 'object') {
        return (0, _utils.atomToVariableString)(variables);
      }

      var schemaName = variables.constructor[_utils.SCHEMA_NAME];
      if (schemaName) {
        return this._schemaTree[schemaName].composeVariables(variables);
      }

      var result = Object.keys(variables).map(function (key) {
        var value = variables[key];
        return key + ': ' + _this2.stringifyVariables(value);
      });
...
exports.default = function (schemaTree) {
  var decorator = function decorator(paths) {
...
exports.default = function (schemaTree) {
  var decorator = function decorator(dataType, alias) {
    return function (proto, fieldName, descriptor) {
      var entityName = proto.constructor.name;

      if (!proto.constructor[_utils.SCHEMA_NAME]) {
        proto.constructor[_utils.SCHEMA_NAME] = entityName;
      }

      var schema = schemaTree[entityName] || new _Schema2.default(schemaTree, entityName, proto.constructor, [entityName]);

      var generatedType = schema.addField(fieldName, dataType, alias);

      return (0, _utils.attachGetterSetter)(fieldName, descriptor, schema.displayName, generatedType, schemaTree);
    };
  };
...
exports.default = function (schemaTree) {
  var decorator = function decorator(dataType, ons) {
    return function (proto, fieldName, descriptor) {
      var entityName = proto.constructor.name;
      ...
      var generatedType = schema.addFieldOn(fieldName, dataType, ons);
...
exports.default = function (schemaTree, engine, isMutation) {
  var decorator = function decorator(operationName, output, input) {
    return function (proto, fieldName, descriptor) {
      // don't know if proto is prototype of class (static or not)
      var entityName = proto.prototype ? proto.name : proto.constructor.name;
      var operationKey = (0, _utils.getOperationKey)(entityName, fieldName);
      ...
      if ((typeof output === 'undefined' ? 'undefined' : (0, _typeof3.default)(output)) === 'object') {
        outputType = _Schema2.default.generateNestedFields(schemaTree, output, [operationKey, 'output']);
      }

      if ((typeof input === 'undefined' ? 'undefined' : (0, _typeof3.default)(input)) === 'object') {
        inputType = _Schema2.default.generateNestedFields(schemaTree, input, [operationKey, 'input']);
      }

      var originFunc = descriptor.value;
      descriptor.value = function () {
        var ret = originFunc.apply(this, Array.from(arguments));
      ...
      var schema = schemaTree[operationKey] = schemaTree[operationKey] || {};
...
exports.GraphEngine = exports.default = undefined;

var _GraphEntity = __webpack_require__(47);

var _GraphEntity2 = _interopRequireDefault(_GraphEntity);

var _GraphEngine2 = __webpack_require__(48);

var _GraphEngine3 = _interopRequireDefault(_GraphEngine2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _GraphEntity2.default;
exports.GraphEngine = _GraphEngine3.default;
